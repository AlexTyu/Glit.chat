...
// default options
ath.defaults = {
	appID: 'Gltddfgffghsgfchfd',		// local storage name (no need to change)
...
ath.Class.prototype = {
	...
	show: function (force) {
		...
		this.element.style.webkitTransform = 'translate3d(0,-50px,0)';
		this.element.style.transform = 'translate3d(0,-50px,0)';
